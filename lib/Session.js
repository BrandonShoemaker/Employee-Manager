...
class Session{
    ...
    setEngineers(name, employeeId, email){
        ...
        .prompt({
            ...
            validate: input => {
                if(this.notEmpty(input) && this.getGitgubs().indexOf(input) >= 0)
                    return false;
                return true;
            }
        })
        .then(engineerObj => {
            this.getGitgubs().push(this.engineerObj.github);
    ...
    setEmployees(){
        ...
        .then(results => {
            ...
            if(results.employeeType === "Team Manager")
                ...
                this.setEmployees(results.name, results.employeeId, results.email);
            else
